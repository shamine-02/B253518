...
```{r message=FALSE}
pacman::p_load(tidyverse, janitor, here, readxl, plotly, sf, gt, ggiraph)
```
...
interactive_plot <- final_salbutamol2122 %>%
  ...
  geom_point() +
  theme_minimal() +
  labs( title = "Average salbutamol prescription against % of households without heating",
        subtitle = " in each Scottish healthboard winter 2021/2022",
