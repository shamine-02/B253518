---
title: Is there a correlation between presriptions of Salbutamol and proportions of
...
heating_map <- girafe(ggobj = heating_plot, options = list(
...
# 
# ggplotly(interactive_plot, options = list(opts_hover_inv(css = "opacity:0.5;")))
...
averages_salbutamol %>% 
  ...
  cols_label(hb_name = "Healthboard",
             ...
             average_salbut = "",
             average_salbut_per100k = "Per 100k of the population") %>% 
  ...
  tab_spanner(label = "Averages across Dec 2021 to Feb 2022",
              columns = c(starts_with("Average")))
