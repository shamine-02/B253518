...
testing <- salbut_population_2122 %>%   
  mutate(across(starts_with("salbutamol")), 
         (pick(starts_with("salbutamol"))*100000)/population, .names = "per100k_{.col}")

testing <- salbut_population_2122 %>%   
  mutate(across(pick(starts_with("salbutamol")),*100000/population, .names = "per100k_{.col}")

.names = "per100k_{.col}"), 

  mutate(.names = "per100k_{.col}")
```
